//package com.mall_management.exception;
//
...
//    public Res fileSizeLimitExceededExceptionHandler(FileSizeLimitExceededException e) {
//        return Res.error("单个文件大小不允许超过2MB");
//    }
//
//    /**
//     * 处理请求数据超大异常
...
//    public Res sizeLimitExceededExceptionHandler(SizeLimitExceededException e) {
...
//    public Res exceptionHandler(Exception e, HttpServletRequest request)
//    {
